...
public class EXCLUIDO_CT1006_VerificarAbaGruposSemConexao extends BaseTest {
	...
	@Test
	public void deveVerificarAbaGruposSemConexao_CT1006(@Param(name = "matricula") String matricula,
...
//		Assert.assertTrue(abaGrupos.obterMensagemSemInternet());
