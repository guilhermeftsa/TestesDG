...
public class CT10XX_VerificarAbaAulasSemAulas extends BaseTest {
	...
	@Test
	public void deveVerificarAbaAulasSemAulas_CT1010(@Param(name = "matricula") String matricula, 
		...
		Assert.assertTrue(aulasAba.isAbaSemAulas());
	}
}
