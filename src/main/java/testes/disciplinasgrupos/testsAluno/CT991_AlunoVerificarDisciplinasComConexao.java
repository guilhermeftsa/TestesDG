...
public class CT991_AlunoVerificarDisciplinasComConexao extends BaseTest {
	...
	@Test
	public void deveVerificarDisciplinasAlunoComConexao_CT991(@Param(name = "matricula") String matricula, 
